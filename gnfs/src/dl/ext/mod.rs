...
//!
//! This module provides the extension-field substrate — the types and maps that lift NFS-DL
//! from F_p to F_{p^k}. It is consumed by the k>1 descent + solver and the MOV bridge.
//!
...
//!   form that `FpExt::to_uint_vec` already produces (over-specified for the MOV bridge).
//!
...
//!   (r>1) and the degree-k prime exponent.
